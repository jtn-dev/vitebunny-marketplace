...
const NFTCard = ({ nft }) => {
  ...
  // Generate image path based on NFT ID
  // Using the NFT's own image property from dummyData but with a fallback
  ...
  return (
    <Link href={`/nft/${nft.id}`} className="group block w-full">
      <div className="overflow-hidden bg-white border border-gray-100 transition-all duration-300 hover:shadow-md h-full w-full">
        <div className="relative">
          ...
          <div className="relative aspect-square w-full overflow-hidden bg-gray-100">
            ...
            {mounted && (
              <button
                onClick={toggleLike}
                className="absolute top-2 right-2 p-1.5 bg-white shadow-sm hover:bg-white transition-colors z-10"
              >
        ...
        {/* NFT Details - now moved completely outside of the image area */}
        <div className="p-3 bg-white">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center bg-gray-50 px-2 py-1 rounded">
              <FaEthereum className="h-2.5 w-2.5 text-black mr-1 flex-shrink-0" />
          ...
          <div className="flex justify-between items-center pt-2 border-t border-gray-100">
            ...
            <div className="flex items-center">
              <div className="w-4 h-4 bg-gray-200 rounded-full mr-1.5 flex-shrink-0"></div>
